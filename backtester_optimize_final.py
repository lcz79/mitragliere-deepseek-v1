...
# --- CLASSE CON LA SINTASSI CORRETTA PER I PARAMETRI ---
class StrategiaOttimizzabile(Strategy):
    # Definiamo i parametri come variabili di classe con valori di default.
    # L'ottimizzatore li sovrascriverà.
    ema_len_short = 20
    rsi_len_short = 14
    rsi_entry_level = 70
    stop_loss_pct = 2.0
...
if __name__ == "__main__":
    # Imposta il metodo di multiprocessing stabile per Mac
    ...
    try:
        ...
        print("2. Avvio OTTIMIZZAZIONE STABILE... (potrebbe richiedere diversi minuti)")
        ...
        bt.plot(filename='backtest_results_optimized.html', open_browser=True)
        print("Grafico salvato in 'backtest_results_optimized.html'.")
